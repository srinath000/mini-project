...
# 3.Initialize Text-to-speech engine for convert this text to speech
def Text_to_speech():
    Message = entry_field.get()
    speech = gTTS(text=Message)
    speech.save('MINI_PROJECT.mp3')
    playsound('MINI_PROJECT.mp3')
...
tkinter.Button(root, text="PLAY", font='arial 15 bold', command=Text_to_speech, width='6').place(x=100, y=350)

tkinter.Button(root, font='arial 15 bold', text='EXIT', width='6', command=Exit, bg='OrangeRed1').place(x=100, y=400)
